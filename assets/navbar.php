...
<nav class="navbar navbar-dark " >
      ...
      <div class="navbar-header" >
        <span class="navbar-brand" >  <img src="../uploads/medical.png" width="30" height="30" class="d-inline-block align-top" alt=""> Injection</span>
      ...
      <ul class="nav nav-pills">
        ...
        <span class="colo"> <i class="caret"> </i> </span> </span>
          ...
          <li><a class="btn btn-default" href="../logout/logout.php"><i class="fa fa-sign-out"></i> LogOut</a></li>
